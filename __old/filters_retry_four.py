...
class Endpoint:
    ...
    def get(self, *args, **kwargs):
        return SyncAsyncHandler(self._sync_func, self._async_func, self.name, *args, **kwargs)
...
class FiltersEndpoint(Endpoint):
    def _sync_func(self,a,b):
        return "works"

def endpoint(name=None):
    def inner(func):
        func(FiltersEndpoint(name or func.__name__))
    return inner
